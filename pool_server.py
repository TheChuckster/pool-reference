...
class PoolServer:
    ...
    async def get_pool_info(self, _):
        ...
        # )
        # return res
        return web.Response(text="Chia pool_info")
    ...
    async def submit_partial(self, request) -> Dict:
        ...
        #     )
        # return res_dict
        return web.Response(text="Chia submit_partial")
...
def start_pool_server():
    ...
    aiohttp_jinja2.setup(app, enable_async=True, loader=jinja2.FileSystemLoader(str('assets/templates')))
